...
export const Dashboard = () => {
  ...
  const { allUsers, allOrders } = useAdminStore();
  ...
  useEffect(() => {
    ...
    !!allOrders && allOrders.map((ele) => {
      if (new Date(Number.parseInt(ele.time)).toLocaleDateString() === new Date().toLocaleDateString()) {
        setTodayMoney(prev => (prev + (ele.bill.totOffPrice)));
      }

      setTotalSales(prev => (prev + (ele.bill.totOffPrice)));
              ...
              <div className="flex flex-row -mx-3">
                <div className="flex-none w-2/3 max-w-full px-3">
                  <div>
                    ...
                    <h5 className="mb-2 font-bold dark:text-white">₹{todayMoney}</h5>
              ...
              <div className="flex flex-row -mx-3">
                <div className="flex-none w-2/3 max-w-full px-3">
                  <div>
                    ...
                    <h5 className="mb-2 font-bold dark:text-white">{!!allUsers && allUsers.length}</h5>
                    <p className="mb-0 dark:text-white dark:opacity-60">
              ...
              <div className="flex flex-row -mx-3">
                <div className="flex-none w-2/3 max-w-full px-3">
                  <div>
                    ...
                    <h5 className="mb-2 font-bold dark:text-white">₹{totalSales}</h5>
                    <p className="mb-0 dark:text-white dark:opacity-60">
        ...
        <div className="w-full max-w-full px-3 lg:w-5/12 lg:flex-none">
          <div className="relative w-full h-full overflow-hidden rounded-2xl">
            ...
            <div className="absolute w-full h-full transition-all duration-500">
              <img className="object-cover h-full" src={carousel1} alt="carousel image" />
            ...
            {/* <!-- slide 2 --> */}
            <div className="absolute w-full h-full transition-all duration-500">
              <img className="object-cover h-full" src={carousel2} alt="carousel image" />
              <div className="block text-start ml-12 left-0 bottom-0 absolute right-[15%] pt-5 pb-5 text-white">
                <div className="inline-block w-8 h-8 mb-4 text-center text-black bg-white bg-center rounded-lg fill-current stroke-none">
            ...
            {/* <!-- slide 3 --> */}
            <div className="absolute w-full h-full transition-all duration-500">
              <img className="object-cover h-full" src={carousel3} alt="carousel image" />
              <div className="block text-start ml-12 left-0 bottom-0 absolute right-[15%] pt-5 pb-5 text-white">
                <div className="inline-block w-8 h-8 mb-4 text-center text-black bg-white bg-center rounded-lg fill-current stroke-none">
          ...
          <div className="relative flex flex-col min-w-0 break-words bg-white border-0 border-solid shadow-xl dark:bg-slate-850 dark:shadow-dark-xl dark:bg-gray-950 border-black-125 rounded-2xl bg-clip-border">
            <div className="p-4 pb-0 mb-0 rounded-t-4">
              <div className="flex justify-between">
                <h6 className="mb-2 dark:text-white">Our Users</h6>
              </div>
            </div>
            <div className="overflow-x-auto">
              <table className="items-center w-full mb-4 align-top border-collapse border-gray-200 dark:border-white/40">
                <tbody>
                  {allUsers.length > 0 && allUsers.map((ele, i) => i < 5 && (
                    <tr key={ele._id}>
                      <td className="p-2 align-middle bg-transparent border-b w-3/10 whitespace-nowrap dark:border-white/40">
                        <div className="flex items-center py-1">
                          <div>
                            <img src={`https://ui-avatars.com/api/?name=${ele.username[0]}&background=000&color=fff&size=45`} className="rounded-xl" alt="Profile Picture" />
                          </div>
                          <div className="ml-6">
                            <p className="mb-0 text-sm font-semibold leading-tight dark:text-white dark:opacity-60">Name:</p>
                            <h6 className="mb-0 text-sm leading-normal dark:text-white">{ele.username}</h6>
                          </div>
                        </div>
                      </td>
                      <td className="p-2 bg-transparent border-b whitespace-nowrap dark:border-white/40">
                        <div className="text-center">
                          <p className="mb-0 text-sm font-semibold leading-tight dark:text-white dark:opacity-60">Email:</p>
                          <h6 className="mb-0 text-sm leading-normal dark:text-white">{ele.email}</h6>
                        </div>
                      </td>
                      <td className="p-2 align-middle bg-transparent border-b whitespace-nowrap dark:border-white/40">
                        <div className="text-center">
                          <p className="mb-0 text-sm font-semibold leading-tight dark:text-white dark:opacity-60">Phone:</p>
                          <h6 className="mb-0 text-sm leading-normal dark:text-white">+91 {ele.phone}</h6>
                        </div>
                      </td>
                      <td className="p-2 text-sm leading-normal align-middle bg-transparent border-b whitespace-wrap dark:border-white/40">
                        <div className="flex-1 text-center">
                          <p className="mb-0 text-sm font-semibold leading-tight dark:text-white dark:opacity-60">Address:</p>
                          <h6 className="mb-0 text-sm leading-normal dark:text-white">{ele.address && ele.address.houseNo ? ele.address.houseNo + " " + ele.address.apartment + " near " + ele.address.suite + ", " + ele.address.city + " - " + ele.address.pincode : ""}</h6>
                        </div>
                      </td>
                    </tr>
                  ))}
                ...
                <li className="relative flex justify-between py-2 pr-4 mb-2 border-0 rounded-t-lg rounded-xl text-inherit">
                  <div className="flex items-center">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-sm leading-tight dark:text-white/80">250 in stock, <span className="font-semibold">346+ sold</span></span>
                    </div>
                  </div>
                  <div className="flex">
                    <button className="group ease-in leading-pro text-sm rounded-3.5xl p-1.2 h-6.5 w-6.5 mx-0 my-auto inline-block cursor-pointer border-0 bg-transparent text-center align-middle font-bold text-slate-700 shadow-none transition-all dark:text-white"><i className="ni ease-bounce text-2xs group-hover:translate-x-1.25 ni-bold-right transition-all duration-200" aria-hidden="true"></i></button>
                  </div>
                </li>
                <li className="relative flex justify-between py-2 pr-4 mb-2 border-0 rounded-xl text-inherit">
                  <div className="flex items-center">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-sm leading-tight dark:text-white/80">123 closed, <span className="font-semibold">15 open</span></span>
                    </div>
                  </div>
                  <div className="flex">
                    <button className="group ease-in leading-pro text-sm rounded-3.5xl p-1.2 h-6.5 w-6.5 mx-0 my-auto inline-block cursor-pointer border-0 bg-transparent text-center align-middle font-bold text-slate-700 shadow-none transition-all dark:text-white"><i className="ni ease-bounce text-2xs group-hover:translate-x-1.25 ni-bold-right transition-all duration-200" aria-hidden="true"></i></button>
                ...
                <li className="relative flex justify-between py-2 pr-4 mb-2 border-0 rounded-b-lg rounded-xl text-inherit">
                  <div className="flex items-center">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-sm leading-tight dark:text-white/80">1 is active, <span className="font-semibold">40 closed</span></span>
                    </div>
                  </div>
                  <div className="flex">
                    <button className="group ease-in leading-pro text-sm rounded-3.5xl p-1.2 h-6.5 w-6.5 mx-0 my-auto inline-block cursor-pointer border-0 bg-transparent text-center align-middle font-bold text-slate-700 shadow-none transition-all dark:text-white"><i className="ni ease-bounce text-2xs group-hover:translate-x-1.25 ni-bold-right transition-all duration-200" aria-hidden="true"></i></button>
                ...
                <li className="relative flex justify-between py-2 pr-4 border-0 rounded-b-lg rounded-xl text-inherit">
                  <div className="flex items-center">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-sm leading-tight dark:text-white/80"><span className="font-semibold">+ 430 </span></span>
                    </div>
                  </div>
                  <div className="flex">
                    <button className="group ease-in leading-pro text-sm rounded-3.5xl p-1.2 h-6.5 w-6.5 mx-0 my-auto inline-block cursor-pointer border-0 bg-transparent text-center align-middle font-bold text-slate-700 shadow-none transition-all dark:text-white"><i className="ni ease-bounce text-2xs group-hover:translate-x-1.25 ni-bold-right transition-all duration-200" aria-hidden="true"></i></button>
